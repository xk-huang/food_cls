...
def save_checkpoint(state, is_best, model_dir):
    ...
    if is_best:
        torch.save({'state_dict_model': state['state_dict_model']}, model_dir + '/ckpt/best.pth.tar')

def load_checkpoint(model_dir, model_type='current'):
    ''' save ckeck point current and the best '''
    if model_type == 'current':
        filename = model_dir + '/ckpt/current.pth.tar'
    elif model_type == 'best':
        filename = model_dir + '/ckpt/best.pth.tar'
    else:
        raise ValueError
